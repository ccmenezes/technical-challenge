/* Product Detail Page */
//Test
//Verify click the product redirects to the product page detail
...
export const PRODUCT_PRICE = '14.15';

export const PRODUCT_NAME = 'Combination Pliers';

export const PRODUCT_CATEGORY = 'Pliers';

export const PRODUCT_BRAND = 'ForgeFlex Tools';

export const TITLE_PRODUCT = /Combination Pliers/;

// Verify click the product out of stock does not allow to add in the cart
export const OUT_OF_STOCK_PRODUCT = 'Long Nose Pliers';

export const OUT_OF_STOCK_PRICE = '14.24';

export const OUT_OF_STOCK_DESCRIPTION =
...
export const OUT_OF_STOCK_CATEGORY = 'Pliers';
